...
public final class Options
{
    ...
    public static String getUsage()
    {
        ...
        sb.append(String.format("  %-40s\t%-40s", "-" + TLSA_RECORD_S +" [port:protocol], --" + TLSA_RECORD +" [port:protocol]",
                                "Display the TLSA records referring to the couple 'port:protocol' (default ones if not specified); -d and -s (which has only the required 'label') are required.")).append("\n");
